(function(){
  ...
  //inteéisense> kód kiegészítés (amikor felajánlja a dolgokat az editor)
  ...
  // kibővítjük a myPlayer object-et, de most egy fgv-t kap nem egy változót:
  myPlayer.levelUp = function(){
    myPlayer.level++;
    myPlayer.health =myPlayer.health + (myPlayer.level*100);
    
  };
  //meghivjuk a myPlayer object levelup property-jét ami egy fgv, ezért kell zárójel
  myPlayer.levelUp();
